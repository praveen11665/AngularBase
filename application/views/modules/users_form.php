...
$mandatory  = ($user_id) ? '' : '<span class="mandatory">*</span>';
 $ci =&get_instance();
$selectRoleDropdown   =  $ci->mcommon->Dropdown('app_roles', array('role_id as Key', 'role_name as Value'), array('status'=>'1'));
?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="first_name" id="first_name" value="<?php echo $first_name;?>" class="form-control" allow-characters/>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="last_name" id="last_name" value="<?php echo $last_name;?>" class="form-control" allow-characters/>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="username" id="username" value="<?php echo $username;?>" class="form-control" <?php echo $readonly;?> allow-characters/>
