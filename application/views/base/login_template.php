...
<html>
    ...
    <body>
        <div class="accountbg" style="background: linear-gradient(90deg,#02a3e7,#032a65)">
            <h1 style="color: #fff; font-size:60px; padding-top: 100px; font-weight: bold; padding-left: 30px; font-size: 75px;letter-spacing: -2px; line-height: 1.12; "><?php echo $this->dbvars->app_name;?></h1>
