...
class Seller extends MY_Controller
{
  ...
  public function add()
  {
    ...
    if( $this->acl_permits('vendor.seller_waiting_for_approval') )
    {
      $this->loadForm();
    }          
	...
	public function loadForm($viewData=array())
  {
    //Page Config
    $viewData = array(
                       'list_title' => $this->lang->line('seller_page_title'),
                       'list_view'  => TRUE,
    ...
    $viewData['dataTableUrl']     = 'Seller/datatable';

    $data = array (
                    'title'     =>  $this->dbvars->app_name.' - '.$this->lang->line('seller_page_title'),
  ...
  function datatable()
  {
    ...
    $whereArray = array('u.auth_level' => '4', 'u.banned' => '1', 'up.profile_status' => '1', 'up.document_status' => '1', 'up.approved_status' => '0');
    ...
    //$this->datatables->edit_column('u.user_id', '$1','waiting_for_approvel(u.user_id, "seller")');
    $this->datatables->edit_column('u.user_id', '$1','get_angular_view(u.user_id, "Seller/angularViewForm", 1)');
  ...
  */
  ...
  public function angularViewForm($user_id='')
  {
    ...
    $formData['approveUrl']     = base_url('seller/approve/');
    $formData['disApproveUrl']  = base_url('seller/disapprove/');
