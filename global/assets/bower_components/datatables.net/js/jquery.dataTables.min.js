...
(function(h) { "function" === typeof define && define.amd ? define(["jquery"], function(E) { return h(E, window, document) }) : "object" === typeof exports ? module.exports = function(E, H) { E || (E = window);
    ...
    function rb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<div class="input-group" style="margin-top: 10px;"> <input type="search" class="form-control searchTableData' + b.sFilterInput + '"/><div class="input-group-append"><button name="clearSearch" class="btn btn-info" onclick="removeDatatableSearch()" style="background-color: #28a2d8; border-color : #28a2d8;">X</button></div></div>',            
            j = d.sSearch,
            ...
            i = h("input", b).val(e.sSearch).attr("placeholder", "Search").on("keyup.DT search.DT input.DT paste.DT cut.DT", g ? Qa(f, g) : f).on("keypress.DT", function(a) { if (13 == a.keyCode) return !1 }).attr("aria-controls", c);
